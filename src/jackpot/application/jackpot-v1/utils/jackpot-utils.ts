            ...
            case BET_ENUMS.plenoAmount:
              {
                ...
                if (totalAmountInBet) {
                  Object.assign(analisNumber, {
                    bets: {
                      [BET_ENUMS.plenoAmount]: totalAmountInBet,
                      ...analisNumber.bets,
                    },
                  });
                }
            ...
            case BET_ENUMS.semiPlenoAmount:
              {
                ...
                const totalAmountInBet =
                  (betNumber.bets.semiPlenoAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.semiPlenoAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            ...
            case BET_ENUMS.firstColumnAmount:
              {
                const mult = columna;
                const totalAmountInBet =
                  (betNumber.bets.firstColumnAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.firstColumnAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.secondColumnAmount:
              {
                const mult = columna;
                const totalAmountInBet =
                  (betNumber.bets.secondColumnAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.secondColumnAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.thirdColumnAmount:
              {
                const mult = columna;
                const totalAmountInBet =
                  (betNumber.bets.thirdColumnAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.thirdColumnAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.firstDozenAmount:
              {
                const mult = docena;
                const totalAmountInBet =
                  (betNumber.bets.firstDozenAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.firstDozenAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.secondDozenAmount:
              {
                const mult = docena;
                const totalAmountInBet =
                  (betNumber.bets.secondDozenAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.secondDozenAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.thirdDozenAmount:
              {
                const mult = docena;
                const totalAmountInBet =
                  (betNumber.bets.thirdDozenAmount as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.thirdDozenAmount]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.chanceSimple1_18:
              {
                const mult = chanceSimple;
                const totalAmountInBet =
                  (betNumber.bets.chanceSimple1_18 as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.chanceSimple1_18]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.chanceSimple19_36:
              {
                const mult = chanceSimple;
                const totalAmountInBet =
                  (betNumber.bets.chanceSimple19_36 as number) * mult;
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.chanceSimple19_36]: totalAmountInBet,
                  });
                }
              }
              break;
            ...
            case BET_ENUMS.cubre0_37_2:
              {
                ...
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.cubre0_37_2]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.cubre37_2_3:
              {
                ...
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.cubre37_2_3]: totalAmountInBet,
                  });
                }
              }
              break;
            case BET_ENUMS.specialCalle:
              {
                ...
                const totalAmountInBet =
                  (betNumber.bets.cubre37_2_3 as number) * (mult as number);
                if (totalAmountInBet) {
                  Object.assign(analisNumber.bets, {
                    [BET_ENUMS.specialCalle]: totalAmountInBet,
                  });
                }
              }
              break;
